...
window.getContentPane().setBackground(new Color(216,191,216));
    ...
    panel4 = new JPanel();
    label5 = new JLabel("Powered by Devoteam GmbH : In partnership with Cisco");
    ...
    dlm.addElement("Welcome To SamyaVPN");
    dlm.addElement("Version: 1.0");
    dlm.addElement("Website: www.devoteam.de ");
    dlm.addElement("Forum: NSO ");
    dlm.addElement("Email:samya.ghosh@devoteam.com ");
    dlm.addElement("!!!!!!!DISCLAIMER!!!!!!!");
    dlm.addElement("Devoteam GmbH.");        
...
public void EliteButton(){
    JOptionPane.showMessageDialog(null, "You Clicked Stop VPN button");
}
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource()== but2){
            ...
            if (e.getSource()== but5){
   JOptionPane.showMessageDialog(null, "Have to get updated");    
